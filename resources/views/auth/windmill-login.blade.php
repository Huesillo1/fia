...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="es">
    <head>
        ...
        <title>Iniciar Sesi&oacute;n - FIA</title>
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <label class="block text-sm">
                    <span class="text-gray-700 dark:text-gray-400" value="{{ __('Email') }}"></span>
                    <input 
                    name="email"
                    type="email"
                ...
                <label class="block mt-4 text-sm">
                    <span class="text-gray-700 dark:text-gray-400" value="{{ __('Password') }}"></span>
                    <input 
                    name="password" 
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                    placeholder="***************" 
              ...
              <p class="mt-1">
                <a class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="{{ route('registe"                Crear cuenta
                </a>
              </p>
            </div>
          </div>
